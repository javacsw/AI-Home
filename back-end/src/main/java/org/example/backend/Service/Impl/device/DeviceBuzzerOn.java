...
///**
// * @author shenxianfang
// * @Description:DeviceBuzzerOn
// * @date 2025/5/26
// * 控制蜂鸣开启
// */
//@WebServlet("/cmd_query_buzzer_on")
//public class DeviceBuzzerOn extends HttpServlet {
//    @Override
...
////        System.out.println("当前时间："+new Date()+"；接收设备数据后开启蜂鸣：" +deviceInfo.toString());
//
//        //处理业务逻辑
//
//        //设置返回数据
//        ResultData resultData = new ResultData();
//        resultData.setAction("on");
//        resultData.setStatus("success");
//        resultData.setDuration("1000");

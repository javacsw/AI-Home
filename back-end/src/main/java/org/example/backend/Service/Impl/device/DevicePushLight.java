...
/**
 * @author shenxianfang
 * @Description:DevicePushLight
 * @date 2025/5/26
 * 接收设备光线强度接口
 */

@WebServlet("/push_light_intensity")
@Service
public class DevicePushLight extends HttpServlet {
    @Autowired
...
//        System.out.println("当前时间："+new Date()+"；接收光线强度数据："+deviceInfo.toString());
        lightService.setData("当前时间："+new Date()+"；接收光线强度数据："+deviceInfo.toString());

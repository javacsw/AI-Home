...
///**
// * @author shenxianfang
// * @Description:DeviceBuzzerOff
// * @date 2025/5/28
// * 控制蜂鸣关闭
// */
//
//@WebServlet("/cmd_query_buzzer_off")
//public class DeviceBuzzerOff extends HttpServlet {
//    @Override
...
////        System.out.println("当前时间："+new Date()+"；接收设备数据后关闭蜂鸣：" +deviceInfo.toString());
//
//        //处理业务逻辑
//
//        //设置返回数据
//        ResultData resultData = new ResultData();
//        resultData.setAction("off");
